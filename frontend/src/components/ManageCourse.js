...
const ManageCourse = () => {
  ...
  useEffect(() => {
    const fetchCourseUnits = async () => {
      try {
        ...
        const response = await httpClient.get(`https://gradex-6c6911643a2a.herokuapp.com/lecturer/${user.id}/courses`);
  ...
  const handleAddTopic = async (e) => {
    ...
    try {
      await httpClient.post('https://gradex-6c6911643a2a.herokuapp.com/create_topic', {
  ...
  const handleDeleteTopic = async (topicId) => {
    try {
      await httpClient.delete(`https://gradex-6c6911643a2a.herokuapp.com/delete_topic/${topicId}`);
      handleCourseUnitChange(selectedCourseUnit);
    } catch (error) {
  ...
  const handleDeleteCourseUnit = async (courseUnitId) => {
    try {
      await httpClient.delete(`https://gradex-6c6911643a2a.herokuapp.com/delete_course_unit/${courseUnitId}`);
  ...
  const handleUploadResource = async (e) => {
    ...
    try {
      ...
      await httpClient.post(`https://gradex-6c6911643a2a.herokuapp.com/add_resource/${selectedTopic.id}`, formData);
  ...
  const handleDeleteResource = async (resourceId) => {
    try {
      await httpClient.delete(`https://gradex-6c6911643a2a.herokuapp.com/delete_resource/${resourceId}`);
      handleTopicClick(selectedTopic);
    } catch (error) {
